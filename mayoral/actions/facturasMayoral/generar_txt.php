...
error_log("Documented Header encoding: " . mb_detect_encoding($documented_headers[0]) . ", Length: " . strlen($documented_headers[0]) . "string: " . utf8_encode($documented_headers[0]));
