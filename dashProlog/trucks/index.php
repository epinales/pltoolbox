  ...
  <div id="carousel-graficas" class="carousel carrusel">
    <div class="carousel-inner">
      <div class="carousel-item active">
        ...
        <div class="row mt-3 ">
          <div class="col"></div>
          <div class="col-md-3 border-grafica mr-2">
            <div id="chart"></div>
          </div>
          <div class="col-md-3 border-grafica mr-2">
            <div id="chart2"></div>
...
require $root . '/pltoolbox/dashProlog/footer.php';
  require $root . '/pltoolbox/dashProlog/dashboard/modales/modal.php';
?>
